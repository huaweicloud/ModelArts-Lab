...
def _patch_recompute_scheduler() -> None:
    """Patch RecomputeScheduler for HMA invalid-block handling and
    producer-KV-expiry release."""
    ...
    rs.RecomputeScheduler.schedule = _patch_schedule
    rs.RecomputeScheduler.update_from_output = _patch_update_from_output
