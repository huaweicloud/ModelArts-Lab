...
wonleing | 1.[搭建数字识别在线服务及完整的验证码的识别应用代码](https://github.com/huaweicloud/ModelArts-Lab/issues/8)；<br> 2.[图像分类第一期实践](https://github.com/huaweicloud/ModelArts-Lab/issues/49#issuecomment-502345060)  | [利用华为云AI平台，训练搭建手写数字识别在线服务，识别本地验证码图片的完整应用案例](https://github.com/huaweicloud/ModelArts-Lab/tree/master/contrib/Leon_number_recognize) | ---- | 3
