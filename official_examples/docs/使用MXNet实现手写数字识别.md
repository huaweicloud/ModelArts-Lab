...
-   针对此示例，ModelArts提供了部署上线需使用的训练脚本、推理代码和配置文件。请获取示例文件并上传OBS指定路径，详细请参见[表2](#zh-cn_topic_0168474775_table8311142123817)。
    ...
    1.  在Github的[ModelArts-Lab](https://github.com/huaweicloud/ModelArts-Lab)工程中，单击“Clone or download“，然后在如下页面中单击“Download Zip“，下载工程。
        ...
        **图 1**  下载ModelArts-Lab<a name="zh-cn_topic_0168474775_fig1230292013811"></a>  
        ![](figures/下载ModelArts-Lab-5.png "下载ModelArts-Lab-5")
...
3.  在“创建训练作业“页面，填写相关信息，参数填写指导请参见如下步骤。
    1.  在基本信息区域，“计费模式“和“版本“为系统自动生成，不需修改。请根据界面提示填写“名称“和“描述“。
        ...
        **图 2**  填写名称和描述<a name="zh-cn_topic_0168474775_fig1928861914262"></a>  
        ![](figures/填写名称和描述-6.png "填写名称和描述-6")
    ...
    2.  在参数配置区域，选择“数据来源“，设置“算法来源“、“运行参数“、“训练输出位置“和“作业日志路径“。
        ...
        **图 3**  参数配置<a name="zh-cn_topic_0168474775_fig1915115195014"></a>  
        ![](figures/参数配置-7.png "参数配置-7")
    ...
    3.  在资源设置区域，单击资源池文本框右侧的“选择“，选择“公共资源池“的“计算型GPU\(P100\)实例“，“计算节点个数“设置为“1“。
        ...
        **图 4**  设置使用的资源<a name="zh-cn_topic_0168474775_fig426511510109"></a>  
        ![](figures/设置使用的资源-8.png "设置使用的资源-8")
...
5.  在“训练作业“管理页面，可以查看新建训练作业的状态。训练作业的创建和运行需要一些时间，预计十几分钟，当状态变更为“运行成功“时，表示训练作业
    ...
    **图 5**  训练作业详情<a name="zh-cn_topic_0168474775_fig11951104893310"></a>  
...
3.  在“导入模型“页面，设置相关参数，然后单击“立即创建“。
    ...
    **图 7**  导入模型<a name="zh-cn_topic_0168474775_fig10359165852519"></a>  
    ![](figures/导入模型-10.png "导入模型-10")
...
2.  在“部署“页面中，设置相关参数，然后单击“下一步“。
    ...
    **图 8**  部署为在线服务<a name="zh-cn_topic_0168474775_fig02506663317"></a>  
...
3.  在“选择预测图片文件“右侧，单击“上传“按钮，上传一张黑底白字的图片，然后单击“预测“。
    ...
    **图 9**  预测结果<a name="zh-cn_topic_0168474775_fig890611184220"></a>  
...
-   删除数据集：在“数据管理\>数据集“页面，在“dataset-mnist“数据集右侧，单击删除按钮。在弹出的对话框中，勾选“删除数据集同时删除桶内文件“，避免OBS因存储数据而继续收费。
    ...
    **图 10**  删除数据集<a name="zh-cn_topic_0168474775_fig14240219113212"></a>  
    ![](figures/删除数据集-13.png "删除数据集-13")
