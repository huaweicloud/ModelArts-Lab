...
torchrun --nproc_per_node=$N_NPUS --master_addr $MASTER_ADDR --master_port $MASTER_PORT ../../infer_batch.py \
         ...
         --batch_test_mode speed \
         --batch_test_resolutions 832x480,1280x720 \
         --batch_test_frames 81,49,17 \
         --batch_test_targets none,encoder,decoder,encoder_and_decoder \
         --batch_test_sample_size 1 \
         --batch_test_report_dir speed_test_results/ \
         --atten_a8w8 \
         --matmul_a8w8 \
         --rope_fused \
         --guidance_scale 3.5 \
