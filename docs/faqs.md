# 费用相关FAQ
1. “新用户ModelArts云资源包” 包含20小时CPU、10小时GPU(注：<B>只包含P100+P4，不包含V100</B>)、10小时自动学习，三种资源，只要其中一个资源用完，即使仍有其他种类资源，若持续使用已用完的资源，仍会按照使用量扣费。当前《ModelArts-Lab AI实战营》活动为开发者设计的满减ModelArts资源套餐包，里面的GPU资源<B>只包含P100+P4，不包含V100</B>，请参加实战营活动的开发者不要选择V100规格，避免产生套餐包之外的费用。
    *目前“新用户ModelArts云资源包”以及“AI开发者包”只包含“北京一”区域，请大家在操作选择“北京一”以免产生扣费！
...
1. 刷新网页；
2. 打开 https://nbviewer.jupyter.org/ ，在如下搜索框中粘贴ipynb文件的地址，如：https://github.com/huaweicloud/ModelArts-Lab/blob/master/notebook/DL_image_recognition/image_recongition.ipynb ，回车，即可查看ipynb文件。
